    ...
    <div class="flex flex-col gap-5 md:gap-10 justify-center items-center">
        <section class="max-w-screen-md">
            ...
            <div class="border-l-2 pl-5 mb-8">
                <p>Наша маленькая творческая артель рассказывает о людях, которые живут рядом с нами: известных и не
                    очень (с такими мы вас знакомили).</p>
                <p>Мы всегда верили в то, что внимательное слушание и бережное отношение дают человеку
                    возможность больше рассказать о себе и быть лучше понятым.</p>
            </div>
            <Spoiler
                class="mb-8"
                title="Что случилось?"
            >
                <p>Мы всегда придерживались принципов финансовой независимости: нашими партнерами были самые классные
                    независимые компании в России и за её пределами.</p>
                <p>Мы снимали рекламные интеграции с такой же нежностью, как и выпуски, а на заработанные деньги
                    свободно и
                    без оглядки делали то, что считали нужным и важным в профессии. </p>
                <p>Этим мы, конечно, бесили российские власти, для которых контроль над всем живым и независимым — едва
                    ли
                    не
                    ключевая аддикция.</p>
                <p>Сперва Катерина Гордеева была объявлена иностранным агентом, но мы не испугались.</p>
                <p>Тогда Госдума написала и приняла закон, угрожающий ответственностью, вплоть до уголовной, тем
                    бизнесам,
                    которые осмелятся давать нам рекламу. </p>
                <p>Но и тут мы решили не сдаваться. Это было бы сейчас слишком простым и слишком легким решением.</p>
                <p>Мы попробуем выстоять.</p>
                <p>Мы никогда не просили у вас деньги и всегда были уверены в том, что сумеем зарабатывать
                    самостоятельно. А
                ...
                <p>Надеемся, у нас получится сотрудничать с брендами и компаниями, не связанными с российским
                    законодательством, возможно, найдутся ещё какие-то идеи для сотрудничества (если они у вас есть,
                    пишите на
                    <a
                        target="_blank"
                        class="font-mono border border-dashed rounded-lg py-1 px-1 bg-boosty-50"
                        href="mailto:anlyalin@gmail.com"
                    >anlyalin@gmail.com</a> ). Но, как минимум, на первых порах
        ...
        <section>
            ...
            <div class="border-l-2 pl-5 mb-8">
                <p>Подписка — самый простой и самый предпочтительный способ нас поддержать. Вам не нужно каждый раз
                    вводить
