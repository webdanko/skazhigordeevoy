<template>
    <div class="max-w-screen-md m-auto">
        <a
            href="/ru"
            class="py-1 px-2 mb-4 inline-flex rounded bg-neutral-300 font-thin text-sm"
        >
            🇷🇺 Читать русскую версию</a>
    </div>
    <div class="flex flex-col gap-5 md:gap-10 justify-center items-center">
        <section class="max-w-screen-md">
            <h2 class="font-bold text-3xl leading-tight mb-8">Hi everyone, this is «Tell Gordeeva»!</h2>
            <div class="border-l-2 pl-5 mb-8">
                <p>Our small creative team shares stories about the people who live around us, whether they are
                    well-known or not so well-known (those we introduced to you). </p>
                <p>We have always believed that attentive
                    listening and careful attitude give people the opportunity to share more about themselves and be
                    better understood.</p>
            </div>
            <Spoiler
                class="mb-8"
            ...
            >
                <p>We have always adhered to the principles of financial independence: our partners have been the
                    coolest independent companies in Russia and abroad.</p>
                <p>We produced advertising integrations with the same care as our regular episodes, and with the money
                    earned, we freely pursued what we considered necessary and important in our profession.</p>
                <p>Naturally, this infuriated the Russian authorities, for whom control over everything alive and
                    independent is almost an addiction.</p>
                <p>First, Katerina Gordeeva was declared a foreign agent, but we were
                    not afraid. </p>
                <p>Then the State Duma wrote and passed a law threatening businesses that dared to advertise with us
                    with consequences, up to criminal liability.</p>
                <p>Even then, we decided not to give up. That would have been too simple and easy a decision.</p>
                <p>We will try to stand firm.</p>
                <p>We have never asked you for money and have always been confident that we
                    could earn it independently. All we needed from you was love and attention.</p>
                <p>We hope to collaborate with
                    brands and companies not tied to Russian legislation, and perhaps other ideas for cooperation will
                    emerge (if you have any, please write to <a
                        target="_blank"
                        class="font-mono border border-dashed rounded-lg py-1 px-1 bg-boosty-50"
                        href="mailto:anlyalin@gmail.com"
                    >anlyalin@gmail.com</a> ). However, at least initially, we will need
                    your help.</p>
            </Spoiler>
            <div class="border-l-2 pl-5 mb-8">
                <p>Therefore, we have created accounts on all popular fundraising platforms in the hope that you will
                    understand and support us.</p>
                <p>Thank you so much 💙</p>
            </div>
        </section>
        <hr class="w-1/2 border">
        <section>
            <h3 class="font-bold text-3xl text-left leading-tight mb-8">Regular Donations</h3>
            <div class="border-l-2 pl-5 mb-8">
                <p> A subscription is the simplest and most preferred way to support us. You won't need to enter your
                    card details each time, and we'll be able to plan our work more than a week in advance.</p>
            </div>
            <div class="subscription">
                <div class="subscription__item">
                    <a
                        target="_blank"
                        href="https://boosty.to/skazhigordeevoy"
                    ...
                    >
                        ...
                        >
                            <g
                                clip-path="url(#clip0_2891_22123)"
                                fill="#fff"
                            >
                                <path
                    ...
                    <span class="text-xs p-2">🇷🇺 For Russian cards</span>
                </div>
                <div class="subscription__item">
                    <a
                        target="_blank"
                        href="https://patreon.com/skazhigordeevoy"
                    ...
                    <span class="text-xs p-2">🌍 For international cards</span>
                </div>
                <div class="subscription__item">
                    <a
                        target="_blank"
                        href="https://www.youtube.com/@skazhigordeevoy/join"
        ...
        <section>
            <h3 class="font-bold text-3xl text-left leading-tight mb-8">One-Time Donations</h3>
            <div class="border-l-2 pl-5 mb-8">
                <p>Subscriptions are great, but not everyone can commit to them. We appreciate any contribution to our
                    work!</p>
            </div>
            <div class="onetime">
                <div class="onetime__item">
                    <a
                        target="_blank"
                        href="https://t.me/tribute/app?startapp=donation_3759"
                ...
                <div class="onetime__item">
                    <a
                        target="_blank"
                        href="https://www.paypal.me/katerinagordeeva"
        ...
        <section>
            <h3 class="font-bold text-3xl text-left leading-tight mb-8">Blockchain — for advanced users</h3>
            <div class="w-full p-4 border border-gray-200 rounded-lg shadow sm:p-6">
                <h5 class="mb-3 font-semibold md:text-xl">Available crypto accounts</h5>
                <p class="text-sm">Click to copy the account number to your clipboard.</p>
                <ul class="my-4 space-y-3">
                    <li v-for="(account, index) in globalStore.crypto">
                        <div
...
<script setup>
    ...
    useSeoMeta({
        title: "Fundraising – youtube-project «Tell Gordeeva»"
    })
</script>
<style></style>