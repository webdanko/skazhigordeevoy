...
onMounted( () => {
  // const clipboard = CopyClipboard( '.copy-button' );
  // const tooltip = Tooltip( '.tooltip-copy-button' );
...
<template>
  <div class="w-full">
    <div class="relative">
      ...
      <button data-copy-to-clipboard-target="copy-button"
              data-tooltip-target="tooltip-copy-button"
        ...
        <span class="hidden inline-flex items-center">
